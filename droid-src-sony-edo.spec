...
#  ./dhs/precheckin.sh droid-src-sony-edo.spec
# Please edit droid-src-sony-edo.spec.tmpl and re-run that command to modify
...
Source100: droid-src-sony-lena.spec.tmpl\
%{nil}
...
%package prebuilts-cmdline-tools
Provides: %{dhs_feature}-prebuilts-cmdline-tools
Group:  System
AutoReqProv: no
Requires: %{dhs_feature}-dhs-utils %{dhs_feature}-dhs-makefile
Requires(post): /bin/sh
Summary: Source for the prebuilts-cmdline-tools src tree to be used for droid-side code building
%description prebuilts-cmdline-tools
This is the src tree for the prebuilts-cmdline-tools subdirectory from the %{device} manifest.
It is only meant for use in the OBS.
...
%package prebuilts-rust-linux-x86
Provides: %{dhs_feature}-prebuilts-rust-linux-x86
Group:  System
AutoReqProv: no
Requires: %{dhs_feature}-dhs-utils %{dhs_feature}-dhs-makefile
Requires(post): /bin/sh
Summary: Source for the prebuilts-rust-linux-x86 src tree to be used for droid-side code building
%description prebuilts-rust-linux-x86
This is the src tree for the prebuilts-rust-linux-x86 subdirectory from the %{device} manifest.
It is only meant for use in the OBS.
...
%post prebuilts-cmdline-tools
# The abuild user is not setup at post time so we use the numeric id
chown -R 399:399 /home/abuild/src/droid/prebuilts/cmdline-tools
%files prebuilts-cmdline-tools
%defattr(-,root,root,-)
/home/abuild/src/droid/prebuilts/cmdline-tools
...
%post prebuilts-rust-linux-x86
# The abuild user is not setup at post time so we use the numeric id
chown -R 399:399 /home/abuild/src/droid/prebuilts/rust/linux-x86
%files prebuilts-rust-linux-x86
%defattr(-,root,root,-)
/home/abuild/src/droid/prebuilts/rust/linux-x86
