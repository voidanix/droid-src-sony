...
#  ./dhs/precheckin.sh droid-src-sony-lena.spec
# Please edit droid-src-sony-lena.spec.tmpl and re-run that command to modify
...
%define ha_device_override sony-lena
